...
Guidance for AI coding agents working in `__REPO__`. It applies to the whole repository.
...
`cvhome-saas/orchestrator`; this file is the repo's own rulebook. Entry points: __ENTRY__.
